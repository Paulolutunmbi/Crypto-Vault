...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface HumbleTokenInterface extends Interface {
    getFunction(nameOrSignature: "FAUCET_AMOUNT" | "FAUCET_COOLDOWN" | "allowance" | "approve" | "balanceOf" | "claimFaucet" | "decimals" | "lastClaimAt" | "name" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface HumbleToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): HumbleToken;
    waitForDeployment(): Promise<this>;

    interface: HumbleTokenInterface;
