...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface FeeRejectorInterface extends Interface {
  ...
  export interface FeeRejector extends BaseContract {
    
    connect(runner?: ContractRunner | null): FeeRejector;
    waitForDeployment(): Promise<this>;

    interface: FeeRejectorInterface;
