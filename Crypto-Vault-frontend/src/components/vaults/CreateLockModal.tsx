            ...
            <div className="flex flex-col gap-1.5">
              ...
              {currentToken && currentToken.address && (
                <div className="rounded-lg bg-[#EDF5ED] px-3 py-2 text-xs text-[#558755] flex flex-col gap-2">
                  ...
                  <button type="button" onClick={() => void handleAddTokenToWallet()} disabled={isWatchingToken} className="self-start rounded-md border border-[#CDE2CD] bg-white px-2.5 py-1.5 font-semibold text-[#2C332B] disabled:opacity-50">
